...
public class Client
{
	...
	private BufferedReader m_in; //Entrée Client <--- Serveur
	...
	public Client(String ip)
	{
		...
		try
		{
			System.out.println("Tentative de création de Client");
			...
			System.out.println("Client connecté à l'ip " + ip + " au port " + Const.S_PORT);
		}
		catch(IOException e)
		{
			e.printStackTrace();
