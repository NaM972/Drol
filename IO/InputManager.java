...
public class InputManager extends Thread
{
	...
	public void run()
	{
		//Tant qu'on ne quitte pas et que les "bus" sont �tablis
		while(!m_quit && m_om != null && m_gm != null)
		{			
			//Le KeyListener est ajouté au JPanel de OutputManager/Display
			if(!m_kb_added)
			{
	...
	{		
		//Attend que G.M. met à zero data et le réveille
		try 
		{
			m_dataSent = true;
	...
	{			
		//Ajoute les données de ce IM, lis celles de tous les clients et envoie le tous au client
		...
		//Applique les données de tous les clients au IM et réinitilise les données du serveur
